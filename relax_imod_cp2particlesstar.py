#!/usr/bin/env python3
# Script to convert IMOD central pair star file to Relion 5 star file
# For now, not dealing without polarity
# Authors: HB, 05/2025
# python ~/Documents/GitHub/ReLAX/relax_imodcp2particlestar.py --i input_mod --o particles.star --tomo_angpix 3.37 --angpix 14.00 --mod_suffix _14.00Apx_doublets.mod --fit ellipse

from util.io import create_dir, create_starfile, create_particles_starfile, imod_cp2star, read_polarity_csv, sanitize_particles_star, add_particle_names, create_data_optics
...
def main():
    ...
    if args.polarity != "":
        ...
        print(f'EXIT!! No polarity file provided.')
        sys.exit(1) 
    ...
    for input_file in matching_files:
        ...
        df_cilia = imod_cp2star(input_file, output_star_file, angpix, tomo_angpix, spacing, fit_method, df_polarity, args.mod_suffix, False)
